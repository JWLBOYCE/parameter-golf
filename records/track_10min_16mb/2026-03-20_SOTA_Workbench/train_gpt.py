...
class Hyperparameters:
    def __init__(self) -> None:
        ...
        self.matrix_lr = float(os.environ.get("MATRIX_LR", "0.02"))
        ...
        self.swa_enabled = bool(int(os.environ.get("SWA_ENABLED", "1")))
        ...
        self.use_bigram_hash = env_flag("USE_BIGRAM_HASH", "1")
        self.use_smeargate = env_flag("USE_SMEARGATE", "1")
